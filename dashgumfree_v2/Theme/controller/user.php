...
if ((isset($_GET['act']) && isset($_GET['user_id'])) || (isset($_POST['act']) && isset($_POST['user_id']))) {
	...
	if ($act == 'view') {
		...
		curl_setopt($ch, CURLOPT_URL, REST_HOST."/MySeniorProject/RESTFulServer/v1/staff/user/".$user_id);
		...
		curl_setopt($ch, CURLOPT_URL, REST_HOST."/MySeniorProject/RESTFulServer/v1/user/".$user_id);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
