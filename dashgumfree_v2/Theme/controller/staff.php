...
if ((isset($_GET['act']) && isset($_GET['staff_id'])) || (isset($_POST['act']) && isset($_POST['staff_id']))) {
	...
	if ($act == 'view') {
		...
		curl_setopt($ch, CURLOPT_URL, REST_HOST."/MySeniorProject/RESTFulServer/v1/staffs/".$staff_id);
	...
	curl_setopt($ch, CURLOPT_URL, REST_HOST."/MySeniorProject/RESTFulServer/v1/staff");
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
